...
geneid_name <- read_csv("01_annotation/anot5.csv")
...
During the work, the uncertain annotation of the TLR01 gene described in the **Alignment** markdown was identified as the TLR01L. This change was applied to the annotation dataset used to join the gene name to the rest of the expression data.
